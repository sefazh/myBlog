    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="first-slide" src="/Public/images/index/carousel.jpg" alt="First slide">
                <div class="container">
            ...
            <div class="item">
                <img class="second-slide" src="/Public/images/index/carousel.jpg" width="100%" alt="Second slide">
                <div class="container">
                    <div class="carousel-caption">
            ...
            <div class="item">
                <img class="third-slide" src="/Public/images/index/carousel.jpg" alt="Third slide">
                <div class="container">
                    <div class="carousel-caption">
...
<div class="container">
    ...
    <div class="row featurette">
        ...
        <div class="col-md-5">
            <img class="featurette-image img-responsive center-block" src="/Public/img/php7.png" data-src="holder.js/500x500/auto" alt="Generic placeholder image">
        </div>
    </div>
